...
class Edit extends \Magento\Backend\App\Action implements HttpGetActionInterface
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Custform_Newmodule::save';
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Custform_Newmodule::newmodule_form')
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\Custform\Newmodule\Model\Form::class);
